const gearData = {
  ...
  "EvervoidArmor": {
    ...
    chaosFusion: [
      "Max Level +5",
      "Swordshield: For every 30% Shield accumulated, gain 10% Shield damage boost. Max 1 stack",
      "Max Level +5",
      "Skill damage +20%",
      "Max Level +5",
      "Ward: Gain 100% Shield when match starts. Skill damage +20%",
      "Max Level +5",
      "Damage to Poisoned targets +30%",
      "Max Level +10",
      "Shieldcore: Required accumulated Shield for each Swordshield stack -15%. Max stacks +3"
    ],
    collectibleSetBoosts: [
  ...
  "moonscarBracer": {
    ...
    collectibleBonuses: [
      ...
      "Moonscar Bracer Eternal Astral Forge skill boosted: Mega Crit II: Crit Rate exceeds 130%, Skill Damage +30%",
      "Moonscar Bracer Eternal Astral Forge skill boosted: Mega Crit I: Crit Rate exceeds 100%, Crit Damage +30%"
    ]
  },
  ...
  "vGlove": {
    ...
    gradeSkills: [
      ...
      "ATK +25%",
      "Sanguine Aura: Enemies in a certain radius will gradually wither (Lose 1% HP/0.1s. Ineffective against bosses)"
    ],
    astralForge: {
